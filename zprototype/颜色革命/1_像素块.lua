...
for r = 0 , 256 , 32 do
	for g = 0 , 256 , 32 do
		for b = 0 , 256 , 32 do
			...
			SIGen.NewHealthEntity( SITypes.entity.simpleEntity , "像素块-"..r.."-"..g.."-"..b )
			.SetLocalisedNames{ "entity-name.sicw-像素块" , r , g , b }
			.SetLocalisedDescriptions{ "entity-description.sicw-像素块" , r , g , b }
			...
			.SetCustomData
			{
				...
				icons = SIPackers.Icon( SICW.picturePath.."item/像素块.png" , tint , 4 ) ,
				pictures = SIPics.NewLayer( SICW.picturePath.."entity/像素块/像素块.png" , 32 , 32 ).Priority( SIPics.priority.veryLow ).Tint( tint ).Get() ,
				render_layer = "object" ,
